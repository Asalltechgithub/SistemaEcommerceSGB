...
{
    public partial class Prod_mais_Vend : System.Web.UI.Page
    {
        ...
        protected void img_Rel_Prod_mais_Vend_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Paragraph paragrafo = new Paragraph("Produtos Mais Vendidos");
