...
namespace WebApplication4.Administrativo.ADM
{
    public partial class Relatórios : System.Web.UI.Page
    {
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Paragraph paragrafo2 = new Paragraph("Data de Emissão : " + DateTime.Now.Date.ToString("dd/MM/yyyy") + " Hora da Emissão  " + DateTime.Now.ToString("T"));
            ...
            Paragraph paragrafo = new Paragraph("Relatório de Produtos");
