...
{
    public partial class Rl_Cli_Compraram_mais : System.Web.UI.Page
    {
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Paragraph paragrafo = new Paragraph("Relatório de Clientes que Compraram Mais .");
            paragrafo.Alignment = Element.ALIGN_CENTER;
            pdfDoc.Add(paragrafo);

            Paragraph paragrafo3 = new Paragraph("De : " + Calendar1.SelectedDate.Date.ToString("dd/MM/yyyy") + "   Até  : " + Calendar2.SelectedDate.Date.ToString("dd/MM/yyyy"));
